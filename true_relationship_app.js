...
const LIFF_ID = "REPLACE_WITH_LIFF_ID"; // ← このミニアプリ用に新規発行したLIFF IDを設定
const PARTNERS_ENDPOINT = "https://script.google.com/macros/s/XXXXXXXXXXXXXXXX/exec"; // ← partners_code.gs デプロイ後の /exec URLを設定
